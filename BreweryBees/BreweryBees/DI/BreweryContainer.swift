...
//       MARK: Registering HomeViewModel
        ...
        // MARK: Rated ViewModel
        breweryResolver.register(RatedBreweryViewModel.self) { resolver in RatedBreweryViewModel(breweryRepositoryProtocol: resolver.resolve(BreweryRepositoryProtocol.self)!)
        }
